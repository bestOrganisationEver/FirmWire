...
import firmwire.vendor.exy5400.hooks
import firmwire.util.logging
import avatar2
import capstone
# from firmwire.vendor.exy5400.osi import ShannonOSI

from avatar2 import *

# import firmwire.vendor.exy5400.task

from firmwire.vendor.exy5400.modkit import TaskMod, NOP_TASK_SNIPPET
...
class Exy5400Machine(FirmWireEmu):
    def __init__(self):
        super().__init__()
...
r12: %08x     cpsr: %08x""" % (
    ...
    def initialize(self, loader, args):
        ...
        exy5400.hooks.panda = self.panda
        ...
        # log.error(qemu.read_register("v0"))
        # log.error(qemu.read_register("is_aarch64"))
        log.error(qemu.write_register("is_aarch64", 0))
        # log.error(qemu.read_register("is_aarch64"))
